...
out = open('tests/benchmark/diagnose_output.txt', 'w', encoding='utf-8')
...
try:
    ...
    blocks = provider.extract('tests/benchmark/docling/unit_test_lists.docx')
    ...
    p()
    p('=== Ground Truth 期望 ===')
    gt = json.load(open('tests/benchmark/ground_truth/unit_test_lists.json', encoding='utf-8'))
